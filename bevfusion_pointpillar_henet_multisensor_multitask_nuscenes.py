...
# datadir settings — align with bevformer_henet_camera_multitask_nuscenes_pretrain.py
# and centerpoint_pointpillar_nuscenes.py (shared bevfusion_nuscenes LMDB)
